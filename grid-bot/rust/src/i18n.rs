...
pub fn t(language: Language, key: Key) -> &'static str {
    ...
    match (language, key) {
        ...
        (English, FieldOutOfRangeAction) => "Perp Out-of-Range Action",
        (Chinese, FieldOutOfRangeAction) => "合约越界动作",
        ...
        (English, FieldExitAssetPolicy) => "Exit Asset Policy",
        (Chinese, FieldExitAssetPolicy) => "退出资产策略",
        (English, FieldMaxPosition) => "Max Position",
        (Chinese, FieldMaxPosition) => "最大仓位",
