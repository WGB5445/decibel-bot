...
pub fn t(language: Language, key: Key) -> &'static str {
    ...
    match (language, key) {
        ...
        (English, TabMarkets) => "2 Markets",
        (Chinese, TabMarkets) => "2 市场",
        (English, TabPreview) => "3 Preview",
        (Chinese, TabPreview) => "3 预览",
        (English, TabMonitor) => "4 Monitor",
        (Chinese, TabMonitor) => "4 监控",
